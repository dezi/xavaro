...
public class GlobalConfigs
{
    ...
    public static final String   BetaVersion     = "0.8.005";
    public static final String   BetaVersionDate = "2016-04-21T23:00:00Z";
    ...
    // @formatter:off
    public static final int IconResEvents             = R.drawable.events_320x320;
    public static final int IconResWebApps            = R.drawable.webapps_512x152;
    ...
    public static final int IconResStorageKnown       = R.drawable.storage_known_420x420;
